...
void displayMenu();
char readSelection();
void printNumberVector(const vector<int>);
vector<int> addNumbertoVector(vector<int>);
void vectorMean(const vector<int>);
void smallestNumber(const vector<int>);
void largestNumber(const vector<int>);
...
int main()
{
    ...
    do
    {
        ...
        // add nums
        case 'A':
            numbers = addNumbertoVector(numbers);
            break;
        // mean of nums
        case 'M':
            vectorMean(numbers);
...
void printNumberVector(const vector<int> numbers)
{
    if (numbers.size() == 0)
...
vector<int> addNumbertoVector(vector<int> numbers)
{
    int num_to_add{};
...
void vectorMean(const vector<int> numbers)
{
    if (numbers.size() == 0)
